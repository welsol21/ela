...
Initializes settings & cache DB via core.db_utils.
"""
import os
...
class MainLayout(BoxLayout):
    def __init__(self, **kwargs):
        ...
        last_dir = get_setting('last_dir', default=os.getcwd(), path=SETTINGS_DB)
        ...
        self.translator_spinner = Spinner(
            text='GPT', values=['GPT', 'DeepL', 'LaraAPI', 'HuggingFace', 'Original']
        )
    ...
    def on_start(self, instance):
        ...
        set_setting('last_dir', last_folder, path=SETTINGS_DB)
